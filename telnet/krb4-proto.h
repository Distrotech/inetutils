...
/* create_auth_reply.c */
KTEXT create_auth_reply (char *, char *, char *, long , int , unsigned long , int , KTEXT );

/* create_ciph.c */
int create_ciph (KTEXT , C_Block , char *, char *, char *, unsigned long , int , KTEXT , unsigned long , C_Block );

/* create_death_packet.c */
KTEXT krb_create_death_packet (char *);

/* create_ticket.c */
int krb_create_ticket KTEXT , unsigned int , char *, char *, char *, long , char *, int , long , char *, char *, C_Block );

/* debug_decl.c */

/* decomp_ticket.c */
int decomp_ticket (KTEXT , unsigned char *, char *, char *, char *, unsigned long *, C_Block , int *, unsigned long *, char *, char *, C_Block , Key_schedule );
...
/* krb_get_in_tkt.c */
int krb_get_in_tkt (char *, char *, char *, char *, char *, int , int (*key_proc (), int (*decrypt_proc )(), char *));
...
/* mk_priv.c */
long krb_mk_priv (u_char *, u_char *, u_long , Key_schedule , C_Block , struct sockaddr_in *, struct sockaddr_in *);
...
/* mk_safe.c */
long krb_mk_safe (u_char *, u_char *, u_long , C_Block *, struct sockaddr_in *, struct sockaddr_in *);
...
/* rd_priv.c */
long krb_rd_priv (u_char *, u_long , Key_schedule , C_Block , struct sockaddr_in *, struct sockaddr_in *, MSG_DAT *);
...
/* rd_safe.c */
long krb_rd_safe (u_char *, u_long , C_Block *, struct sockaddr_in *, struct sockaddr_in *, MSG_DAT *);

/* read_service_key.c */
int read_service_key (char *, char *, char *, int , char *, char *);

/* recvauth.c */
int krb_recvauth (long , int , KTEXT , char *, char *, struct sockaddr_in *, struct sockaddr_in *, AUTH_DAT *, char *, Key_schedule , char *);
...
/* sendauth.c */
int krb_sendauth (long , int , KTEXT , char *, char *, char *, u_long , MSG_DAT *, CREDENTIALS *, Key_schedule , struct sockaddr_in *, struct sockaddr_in *, char *);
