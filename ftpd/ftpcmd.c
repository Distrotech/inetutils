...
{
       0,   154,   154,   156,   162,   166,   171,   177,   199,   204,
     239,   251,   263,   267,   271,   277,   283,   289,   294,   300,
     305,   311,   317,   321,   327,   340,   344,   349,   355,   359,
     375,   379,   385,   391,   396,   401,   405,   410,   420,   435,
     448,   454,   470,   476,   521,   537,   558,   563,   569,   579,
     593,   598,   601,   605,   609,   638,   642,   646,   653,   658,
     663,   668,   673,   677,   682,   688,   696,   700,   704,   711,
     715,   719,   726,   763,   767,   795
};
#endif
...
static const char *const yytname[] =
{
  ...
  "mode_code", "pathname", "pathstring", "octal_number", "check_login", YY_NULL
};
#endif
...
#line 611 "ftpcmd.y"
    {
			...
			snprintf (a, sizeof (a), "%u.%u.%u.%u",
				(yyvsp[(1) - (11)].i) & 0xff, (yyvsp[(3) - (11)].i) & 0xff, (yyvsp[(5) - (11)].i) & 0xff, (yyvsp[(7) - (11)].i) & 0xff);
